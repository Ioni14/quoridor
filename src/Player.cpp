...
bool Player::canMove(const Board& board, const int& di, const int& dj) const
{
    ...
    if (cells[m_iPos + di][m_jPos].hasPlayer()
        && ((di == -1 && !cells[m_iPos][m_jPos].hasWallWest() && (cells[m_iPos + di][m_jPos].hasWallWest() || cells[m_iPos + di*2][m_jPos].hasPlayer()))
        || (di == 1 && !cells[m_iPos][m_jPos].hasWallEast() && (cells[m_iPos + di][m_jPos].hasWallEast() || cells[m_iPos + di*2][m_jPos].hasPlayer()))))
    {
        if (dj == -1 &&
    ...
    if (cells[m_iPos][m_jPos + dj].hasPlayer()
        && ((dj == -1 && !cells[m_iPos][m_jPos].hasWallNorth() && (cells[m_iPos][m_jPos + dj].hasWallNorth() || cells[m_iPos][m_jPos + dj*2].hasPlayer()))
        || (dj == 1 && !cells[m_iPos][m_jPos].hasWallSouth() && (cells[m_iPos][m_jPos + dj].hasWallSouth() || cells[m_iPos][m_jPos + dj*2].hasPlayer()))))
    {
        if (di == -1 &&
